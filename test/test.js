...
var isoContours = require('../../marchingsquares.js').isoContours;
...
test('isoBands input validation', function (t) {
    ...
    t.throws(function(){isoBands('string', 0, 5)} , /data should be an array of arrays/, 'invalid data');
    t.throws(function(){isoBands([1], 0, 5)}, /data should be an array of arrays/, 'invalid data again');
    t.throws(function(){isoBands(dataArr, null, 5)}, /lowerBand is required/, 'missing lowerBand');
    t.throws(function(){isoBands(dataArr, 0, null)}, /bandWidth is required/, 'missing lowerBand');
    t.throws(function(){isoBands(dataArr, 'number', 3)}, /lowerBand must be a number/, 'invalid lowerBand');
...
test('isoContours input validation', function (t) {
    ...
    t.throws(function(){isoContours('string', 0)}, /data should be an array of arrays/, 'invalid data');
    t.throws(function(){isoContours([1], 0)}, /data should be an array of arrays/, 'invalid data again');
